...
<?php
    ...
    $email = "";
    $pass = "";
          	$tpass = $_SESSION["password"];
          	$temail = $_SESSION["email"];

    echo "<script>console.log('$tpass')</script>";
       echo "<script>console.log('$temail')</script>";
    function checklogin(){
      	if(empty($_SESSION["email"]) && empty($_SESSION["password"]))
      		//header("Location: loginparth.php");
      		echo "<p>string</p>";
      	else
    ...
    $pass = $_POST["pass"];
      ...
      if($num_rows > 0){
       ...
       echo "<script>console.log('$tempemail')</script>";
       echo "<script>console.log('$temppass')</script>";
